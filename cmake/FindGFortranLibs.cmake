...
execute_process(COMMAND "gfortran" "-v" ERROR_VARIABLE
  GFORTRAN_VERBOSE_STR RESULT_VARIABLE FLAG)
# For debugging
message(STATUS "'gfortran -v' returned:")
string(SUBSTRING "${GFORTRAN_VERBOSE_STR}" 0 20 GFORTRAN_SHORT)
message(STATUS "${GFORTRAN_SHORT} [...]")
...
string(REGEX REPLACE "^([0-9]+)\\.[0-9]+\\.[0-9]+" "\\1" GFORTTRAN_MAJOR "${GFORTRAN_VERSION_STRING}")
string(REGEX REPLACE "^[0-9]+\\.([0-9]+)\\.[0-9]+" "\\1" GFORTTRAN_MINOR "${GFORTRAN_VERSION_STRING}")
string(REGEX REPLACE "^[0-9]+\\.[0-9]+\\.([0-9]+)" "\\1" GFORTTRAN_PATCH "${GFORTRAN_VERSION_STRING}")
...
string(REGEX REPLACE "[\n\t ]$" "" GFORTRAN_EXEC_PREFIX_DIR "${GFORTRAN_EXEC_PREFIX_DIR}")
...
set(GLIB_DIRS ${GFORTRAN_LIBRARIES_DIR})
list(APPEND GLIB_DIRS ${GFORTRAN_EXEC_PREFIX_DIR}/lib)
list(APPEND GLIB_DIRS ${GFORTRAN_EXEC_PREFIX_DIR}/lib/gcc/${GFORTTRAN_MAJOR})
list(APPEND GLIB_DIRS ${GFORTRAN_LIBRARIES_DIR}/../${GFORTTRAN_MAJOR}/lib)
list(APPEND GLIB_DIRS ${GFORTRAN_EXEC_PREFIX_DIR}/lib/gcc/${GFORTRAN_ARCH}/${GFORTTRAN_MAJOR})
